  ...
  return (
    <div className="max-w-4xl mx-auto p-6">
      <div className="flex items-center justify-between mb-6">
        <h2 className="text-3xl font-bold text-gray-800">Hotel List</h2>
        <button
          ...
          <table className="min-w-full text-sm text-left">
            <thead>
              <tr className="bg-gray-50 text-gray-700">
                <th className="px-6 py-3 font-medium border-b">Hotel Name</th>
            ...
            <tbody>
              {hotels.map((hotel) => (
                <tr key={hotel._id} className="hover:bg-gray-50">
                  <td className="px-6 py-4 border-b">{hotel.name}</td>
                  <td className="px-6 py-4 border-b">{hotel.location}</td>
